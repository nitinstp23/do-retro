defmodule DoRetro.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, DoRetro.Repo)
  ...
  """
  def valid_password?(%DoRetro.Accounts.User{hashed_password: hashed_password}, password)
